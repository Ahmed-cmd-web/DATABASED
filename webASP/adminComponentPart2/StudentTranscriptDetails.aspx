<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentTranscriptDetails.aspx.cs" Inherits="webASP.StudentTranscriptDetails" %>
        ...
        <SortedDescendingHeaderStyle BackColor="#000065" />
         ...
         <Columns>
            ...
            <asp:TemplateField HeaderText="Student First Name">
                <ItemTemplate>
                    <asp:Label ID="Student_fname_col_label" runat="server" Text='<%# Eval("f_name") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Student Last Name">
                <ItemTemplate>
                    <asp:Label ID="Student_lname_col_label" runat="server" Text='<%# Eval("l_name") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Course Name">
             <ItemTemplate>
                 <asp:Label ID="Course_name_col_label" runat="server" Text='<%# Eval("name") %>'></asp:Label>
             </ItemTemplate>
         </asp:TemplateField>

         <asp:TemplateField HeaderText="Exam Type">
             <ItemTemplate>
                 <asp:Label ID="Student_id_col_label" runat="server" Text='<%# Eval("exam_type") %>'></asp:Label>
             </ItemTemplate>
         </asp:TemplateField>

         <asp:TemplateField HeaderText="Grade">
             <ItemTemplate>
                 <asp:Label ID="major_col_label" runat="server" Text='<%# Eval("grade") %>'></asp:Label>
             </ItemTemplate>
         </asp:TemplateField>
